...
3. A Reseller/Partner or one of the Ximiq-Consultants refers the Report Generator to a customer. This is done by sending an E-mail, a chat message or a call.

The first event automatically creates a new Lead in Ximiqs CRM-System. Since there’s no notification, the new leads must be checked. After the other two events, a new lead must be created. Then an initial E-mail with the following content is sent: 

- A link to book a live demo
- Mention of the possibility to request a trial license
- The pricing model

If the customer requests a live demo, an appointment will be automatically generated. The live demo takes place. If the customer requests a trial license, the license will be sent to them. After 30 days, another reminder E-mail including the price information is sent to the customer. If there is still no feedback, after 14 days, the lead is closed as lost.

However, if the customer orders the full license, the deal is registered in the CRM and the pricing is calculated based on the type of license chosen and the size of the customer in terms of number users. The accountant is then informed in order to create a new invoice based on the information registered in the CRM. The accountant forwards the invoice to the Consultant who will then send it to the customer. If the customer doesn’t pay the invoice, an E-mail reminder is sent by the Consultant. Should there not be feedback from the customer, the lead is closed as lost.
...
| 10  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS10.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS10.png) | The potential customer has the chance to book an appointment via booking-link from the initial E-mail. |  |
...
| 13  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS13.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS13.png) | After sending the initial E-mail Ximiq waits two weeks for an answer. |   | 
| 14  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS14.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS14.png) | If the customer doesn’t answer within two weeks a reminder/follow-up E-mail is sent. | This process step could be eliminated as it is over-processing. If client is interested they would come back. | 
| 15  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS15.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS15.png) | After sending the reminder E-mail Ximiq waits two weeks for an answer.  |   | 
...
| 18  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS18.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS18.png) | The license key and a users handbook is sent to the customer by E-mail.   | This process step could be automated.   | 
| 19  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS19.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS19.png) | The customer can try the report generator for 30 days. The consultant then sends a follow up E-mail. | Does not automatically remind the Consultant. |
| 20  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS20.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS20.png) | A follow up E-mail is sent to the customer with the following content: Asking how they liked the Report Generator, Pricing information |   This can be integrated already in previous E-mail. No need for additional E-mails.  |
...
| 24  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS24.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS24.png) | The Price is calculated based on the following pricing model: Single User: USD 360.00 p.a; Team 10: USD 2520.00 p.a; Team 30: USD 5400.00 p.a; Unlimited: upon request;   | The calculation could be done automatically based on employee size within the order entry in CRM. | 
| 25  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS25.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS25.png) | The Consultant informs the accountant about the new order via E-mail. | This process step could be automated. | 
...
| 27  | ![AS-IS-PROCESS/SCREENSHOTS-PROCESS-ELEMENTS/ASIS27.png](https://github.com/DigiBP/Team-Apples/blob/c359fb74a7a2e72c2f18677aa13f3012f2183d54/AS-IS-PROCESS/Screenshots-Process-Elements/ASIS27.png) | The accountant forwards the invoice to the Consultant via E-mail. | The accountant could send the invoice directly to the customer. Or it could even be automated fully with no human involvement. | 
...
| 3   | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE03.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE03.png) | An initial E-mail is sent to the customer. The E-mail includes a link to order a 30 days free trial license as well as a link to the Chatbot in case there are questions.  | [2. Sent e-mail with URL links](https://github.com/DigiBP/Team-Apples#2-sent-e-mail-with-url-links)  | 
| 4   | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE04.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE04.png) | The customer then either orders the  30 days free trial license or not. | Event based gateway waits until one of the messages get triggered. Without any message triggering the token will remain at the gateway. | 
...
| 15  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE15.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE15.png) | Time passes until the 30 days free trial license expires.  | Camunda is not doing much here as it is done automatically by the [scenario 6](https://github.com/DigiBP/Team-Apples#6-sent-license-key-order-form-url).  | 
...
| 17  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE17.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE17.png) | The customer then either orders the full license or not.  | Event based gateway waits until one of the messages get triggered. Without any message triggering the token will remain at the gateway.  | 
...
| 22  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE22.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE22.png) |  The price for the full license is taken from the CRM, which was calculated in scenario 1 and an invoice is created and sent automatically.    | [8. Create Invoice and send](https://github.com/DigiBP/Team-Apples#8-create-invoice-and-send)| 
...
| 24  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE24.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE24.png) | The customer then either paid or not. |  This needs to be indicated in the User task in the Task list. In Camunda the Yes and No is defined with a Condition Expression that is referring to the field names from the previous user task "Confirm payment". | 
...
| 27  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE27.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE27.png) | If the customer pays, the full license key is generated. | [9. Generate license key](https://github.com/DigiBP/Team-Apples#9-generate-license-key) | 
| 28  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE28.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE28.png) | The license key is registered in CRM. | [9. Generate license key](https://github.com/DigiBP/Team-Apples#9-generate-license-key) | 
| 29  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE29.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE29.png) | The license key is automatically sent to the customer. | [10. Sent license key](https://github.com/DigiBP/Team-Apples#10-sent-license-key)| 
...
| 31  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE31.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE31.png) | After 330 days a form to renew the license key is automatically sent to the customer.  | [11. Sent license renewal form URL](https://github.com/DigiBP/Team-Apples#11-sent-license-renewal-form-url) | 
| 32  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE32.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE32.png) | The customer then either requests the renewal or not. | Event based gateway waits until one of the messages get triggered. Without any message triggering the token will remain at the gateway. | 
...
| 37  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE37.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE37.png) | A Consultant then manually checks the account and updates the renewal date in the Task list. | Completion of the User task will notify automatically via Custom webhook - as there is an execution listener in the outgoing sequence flow - the last scenario which will then trigger the service task "Confirm renewal" and write back the new expiry date into the CRM system. User task to be completed in task list. [Check the task](https://github.com/DigiBP/Team-Apples#confirm-payment-and-renew-license)| 
| 38  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE38.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE38.png) | The customer then either pays or not | In Camunda the "Yes" and "No" is defined with a Condition Expression that is referring to the field names from the previous user task "Client made payment?". | 
| 39  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE39.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE39.png) | Ximiq waits for 30 days for the payment. | Going back to the client could be an option but that would stop the Consultant from doing more important things such as winning other leads. | 
...
| 41  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE41.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE41.png) |  The renewal is automatically confirmed to the customer.   |  [13. Confirm renewal](https://github.com/DigiBP/Team-Apples#13-confirm-renewal)   | 
| 42  | ![TO-BE-PROCESS/BPMN-SCREENSHOTS/TOBE42.png](https://github.com/DigiBP/Team-Apples/blob/fd3b11aaf18135496621c8368adca24553044478/TO-BE-PROCESS/BPMN-Screenshots/TOBE42.png) | The renewal is automatically registered in CRM. | [13. Confirm renewal](https://github.com/DigiBP/Team-Apples#13-confirm-renewal)  | 

# Make (formerly Integromat) - Scenarios

<img alt="Make Logo" sizes="(max-width: 30%) 30vw, 30%" src="https://images.ctfassets.net/qqlj6g4ee76j/1k5wBPhbu5kXiaYlFWgEJE/1809be456ba9c4246f7c8fb5d23bd6ef/Make-Logo-RGB.svg" decoding="async" data-nimg="responsive" style="width: 30%; height: auto;">
...
- An E-mail is automatically generated using the "Gmail - Sent an E-mail" module. 
- The scenario retrieves data from the CRM, such as customer information, order details, or any other relevant data.
- The E-mail is sent to the client without any human interaction. This step is automated, meaning that the system handles it automatically without requiring manual intervention.
...
- Once the remaining days are zero, an E-mail is automatically sent to the client.
- The E-mail contains a URL that directs the client to a Google form where they can order the one-year license key.
...
- An E-mail is then sent to the recipient, attaching the generated invoice as a PDF file. 
...
- Records Company ID and E-mail in Google Sheets for Customer Service get in contact with client
...
Using Custom Webhooks in make.com, we have managed to capture the Client ID which is then used to respond to queries in real-time. For example, should the customer forget about their trial license, they can ask the chatbot directly to provide it by using their Client ID. This is possible thanks to the feature “Response fulfillment” looks for and matches the Client ID in our Google Sheet database. The customer receives an answer immediately in the chatbot, avoiding to contact a live agent.
...
We also integrated directly in the chatbot the option to schedule or reschedule live demonstrations or a live meeting with our Consultants. This is useful when the customer wants to better understand our solutions, when they missed a demo or if they simply need to change a live demo date or time.
...
# Conclusion
Any organization must optimize its processes, but this is especially true in the consulting sector where value-added activities are of the essence. A streamlined and successful consulting process enables consultants to make the best use of their time, focus on offering strategic insights, generate more leads and turn them into customers, which promotes sales and ultimately business growth.

Throughout the process with Ximiq, we understood the significance of integrating a clear workflow and process automations using many of the tools learned during our class Digitalizing Business Processes. An extensive analysis was conducted, beginning with an understanding of the process AS-IS, pin-pointing the inefficiencies, and concentrating on the opportunity for improvement. In order to offer a visual picture of the current activities and aid identify bottlenecks and opportunities for streamlining, we used a Business Process Model and Notation (BPMN) process.

In Ximiq's sales process, our analysis revealed enormous waste, including manual operations that provided no added value to the customers, the potential of consultants and accountants lost, and excessive processing time. We discovered that providing accurate pricing information, automated trial license keys, and consultant demos added the most value and were key to test the solution and drive business.

To address these issues, a lean and streamlined process was proposed, aimed at better resource allocation, particularly given that sales engagement was being handled entirely by consultants who were focused on manual activities which were adding no value to the customer. Key improvements were made in automating several tasks, and a Chatbot was implemented to manage queries from clients, freeing up consultants' time to focus on value-added interactions. A structured workflow was put in place to ensure timely client communication and follow-ups, especially after the 30-day trial phase. We also proposed to automate various accounting tasks to further increase efficiency and reduce waste on Ximiq’s back-office team.

Should this process be implemented by Ximiq, it may have a revolutionary effect. The flow efficiency, calculated as Value Added Time divided by Process Lead Time, has greatly increased, despite the fact that we are unable to determine the precise amount of time spent on each user’s job. Ximiq may foresee a potential rise in lead conversion due to the increased quality of consultant-client interactions.

In conclusion, Ximiq's process optimization highlights the significance of consultants concentrating on value-adding tasks and generating new business. It exemplifies how taking a strategic approach to process improvement may lower waste, boost productivity, and eventually boost sales and profit.

# Suggestions
The solution, however, requires several changes from Ximiq's side, such as modifying the lead creation trigger points. The various providers should have the same link to a common form, enabling automatic updates in the CRM system. Another crucial aspect that has not been included in the solution due to the absence of real data and a connection is the integration of an E-mail notification when the client makes a payment. Typically, banks send notifications that can be read using a module called "Gmail - Watch E-mail" and subsequently processed within the workflow. Similarly, the Live Demo scheduling form could also be integrated into this BPMN workflow. For the chatbot questions, a role needs to be defined in addition. This agent should be able to manage the open questions from the clients. 
